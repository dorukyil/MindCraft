...
import {
  ...
  Download, FileText, Loader2, Upload,
} from 'lucide-react';
                        ...
                        {asnSubs.length === 0 ? (
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            {asnSubs.map(sub => (
                              <div
                                key={sub.id}
                                className="bg-black/30 border-l-4 border-[#83aeff]/60 px-3 py-2 flex items-center gap-3"
                              >
                                ...
                                <span className="text-white/50 font-mono text-xs shrink-0 truncate max-w-[130px] hidden md:block">
                                  {sub.file_name}
                                </span>
                                <button
